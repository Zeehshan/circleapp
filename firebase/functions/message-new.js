...
const newMessages = functions
    ...
    .onCreate(async (snap, context) => {
        ...
        for (const userSnapshot of users.docs) {
            ...
            if (authorId !== uid) {
                 userGroupUpdate(context.params.groupId, uid, context.params.channelId);
                 flagChannelUnread(context.params.groupId, context.params.channelId, uid);
                 sendNewMessagePush(uid, body, attachment, context, author.data());
            }
        }
